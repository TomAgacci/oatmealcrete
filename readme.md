...
===========================================================<br>
Oatameal Crete: Here's some instructions<br>
===========================================================<br>
...
BASE RATIOS (BY MASS)
  ...
  - Water:                       1.6–2.0 parts (adjust to workability)
...
PHASE 2 — EARLY CURE (DAY 1–7)
  ...
  - Place on racks with airflow.
  - Maintain moderate humidity (no soaking).

PHASE 3 — MAIN CURE (DAY 7–28)
  - Store dry and ventilated.
  - Lime binder carbonates with CO₂ from air.
...
At 28 days:
  - Main compressive test.
  - Record failure load, failure mode, density.
